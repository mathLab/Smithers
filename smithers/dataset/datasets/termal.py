...
class TermalDataset(AbstractDataset):

    parametric = True
    time_dependent = False
    description = "termal TODO"
    data_directory = os.path.join(os.path.dirname(__file__), 'termal')
    ...
    def plot(self, idx=0):
        plt.tripcolor(self.triang, self.snapshots[idx])
        plt.colorbar()
        plt.show()

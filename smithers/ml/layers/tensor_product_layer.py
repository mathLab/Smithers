'''
Module handling the creation of a layer for the projection of a tensorial
object (case 1D it corresponds to nn.Linear.
'''
...
class tensor_product_layer(nn.Module):
    """
    Class that handles the definition of a PyTorch layer created to
    ...
    def forward(self, input_tensor):
        ...
        if len(input_tensor.shape) == len(self.list_of_matrices):
            ...
            return tensor_reverse(input_tensor)
